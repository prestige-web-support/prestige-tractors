...
(function (w, d) {
  ...
  function megaHtml(kind) {
    if (kind === "equipment") {
      ...
      return '<div class="mega glass"><div class="mega-grid"><div class="mega-cats">' + cats + "</div>" + featureHtml("Featured", "Browse the full catalogue", "Filter by category, brand, horsepower and price across our complete range.", ROUTES.equipment, "View all equipment", PT.PHOTO.tractorHarvest) + featureHtml("Now available", "Used Tractors & Equipment", "Quality pre-owned machinery, inspected and ready to work — browse current used stock.", ROUTES.equipment + "?condition=used", "Browse used stock", PT.PHOTO.usedMachinery, "mega-feature--wide") + "</div></div>";
    }
    if (kind === "brands") {
